...
* 🚗 **Teddy Car Rental:** Developing a comprehensive fleet management system using **Prisma ORM** and **PostgreSQL**.
* 🛡️ **Mama Ethiopia:** Fintech platform architected for diaspora investment and secure financial transactions.
* 🎓 **Gbi Gebeya:** A peer-to-peer marketplace ecosystem built with **Next.js** and **Node.js** for university students.
* 📋 **Digital Queue Management:** Streamlining government sub-city appointments with high-fidelity UI/UX.

### 🐧 Environment & Philosophy
* **OS:** Debian Linux (Stability first)
* **Design:** High-end "DeFi" aesthetics, glassmorphism, and user-centric flows.
* **Goal:** Bridging the gap between complex backends and fluid, 3D-inspired frontends.
